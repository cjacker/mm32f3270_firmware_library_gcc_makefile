...
void SPI2_DMA_RX_Init()
{
    ...
    DMA_InitStruct.DMA_PeripheralBaseAddr = (u32) & (SPI2->RDR);
    DMA_InitStruct.DMA_MemoryBaseAddr = (u32)gRxData;
...
void SPI2_DMA_TX_Init()
{
    ...
    DMA_StructInit(&DMA_InitStruct);
    DMA_InitStruct.DMA_PeripheralBaseAddr = (u32) & (SPI2->TDR);
    DMA_InitStruct.DMA_MemoryBaseAddr = (u32)gTxData;
