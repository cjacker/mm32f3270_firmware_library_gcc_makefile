...
#define KEY1_PIN_SOURCE                 GPIO_PinSource1
#define KEY2_PIN_SOURCE                 GPIO_PinSource2
#define KEY3_PIN_SOURCE                 GPIO_PinSource10
#define KEY4_PIN_SOURCE                 GPIO_PinSource11
#define WK_UP_PIN_SOURCE                GPIO_PinSource0
