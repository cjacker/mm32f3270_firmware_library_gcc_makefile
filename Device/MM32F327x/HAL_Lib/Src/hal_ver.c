...
// MM32 Library release date is 2021-12-15 (YYYY-MM-DD)
...
#define __MM32_LIB_RELESE_DAY           (0x15U)                                 //!< [7:0]   release day
